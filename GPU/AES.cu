...
namespace cuda::aes
{
	...
	__constant__ unsigned char inv_sbox[16 * 16] = {
	...
	__constant__ unsigned char EXP_2[] = {
	...
	__constant__ unsigned char EXP_3[] = {
	...
	__constant__ unsigned char EXP_9[] = {
	...
	__constant__ unsigned char EXP_11[] = {
	...
	__constant__ unsigned char EXP_13[] = {
	...
	__constant__ unsigned char EXP_14[] = {
	...
	__forceinline__ __device__ void SubBytesShift(const unsigned char block[16], unsigned char temp[16])
	{
		temp[0] = sbox[block[0]];
		temp[1] = sbox[block[5]];
	...
	__forceinline__ __device__ void InvSubBytesShift(const unsigned char block[16], unsigned char temp[16])
	{
	...
	template<class T>
	__forceinline__ __device__ __host__ void Shift1(T& a, T& b, T& c, T& d)
	{
		T temp = a;
		a = b;
		b = c;
	...
	__forceinline__ void KeyExpansion(const unsigned char* input, unsigned char* output)
	{
		// First
